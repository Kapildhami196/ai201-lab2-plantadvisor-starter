...
def lookup_plant(plant_name: str) -> dict:
    ...
    return {
        "found": False,
        "name": plant_name,
        "message": f"'{plant_name}' is not in the plant database. I don't have specific care data for this plant. Acknowledge this honestly and offer general advice based on what the user describes about the plant.",
    }
